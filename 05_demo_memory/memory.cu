...
/*
Memory access speed: local memory > shared memory > global memory
*/
...
// hardcoding 128 threads/elements and omitting out-of-bounds checks
...
int main(int argc, char **argv)
{
    ...
    /*
     * Call a kernel that shows using global memory
     */
    ...
    timer.Stop();
    printf("Share memroy Time elapsed = %g ms\n", timer.Elapsed());
